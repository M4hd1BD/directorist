...
class Settings {
	...
	public function create_all_sections() {
	...
	private function is_parent_section( $args ) {
		return empty( $args['parent'] ) ? true : false;
	}

	private function add_field_data( $fields ) {
